...
public class TunerConstants {
    ...
    private static final LegacySwerveDrivetrainConstants DrivetrainConstants = new SwerveDrivetrainConstants()
            .withCANbusName(kCANbusName)
            .withPigeon2Id(kPigeonId)
            .withPigeon2Configs(pigeonConfigs);

    private static final LegacySwerveModuleConstantsFactory ConstantCreator = new SwerveModuleConstantsFactory()
